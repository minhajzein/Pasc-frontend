				...
				if (image64 !== null) {
					...
					if (values.eventType !== 'free' && values.eventFee === '') {
						...
						const credentials = {
							...
							teamLimit:
								values.limit === 'limited' ? Number(values.teamLimit) : 0,
							eventFee:
								values.eventType === 'Free' ? 0 : Number(values.eventFee),
					...
					>
							...
							<div className='flex justify-between w-full'>
								<div className='w-[45%]'>
									...
									<input
										...
										onChange={e =>
											formik.setFieldValue('playersLimit', e.target.value)
										}
									/>
								</div>
								<div className='w-[45%]'>
									...
									<input
										...
										onChange={e =>
											formik.setFieldValue('teamLimit', e.target.value)
										}
									/>
								</div>
							</div>
						...
						<div className='w-full'>
							...
							<input
								...
								onChange={e =>
									formik.setFieldValue('startingDate', e.target.value)
								}
								type='date'
						...
						<div className='w-full'>
							...
							<input
								...
								onChange={e =>
									formik.setFieldValue('endingDate', e.target.value)
								}
								type='date'
								placeholder='dd-mm-yyyy'
							/>
