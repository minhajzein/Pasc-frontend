...
function Login() {
	...
	return (
		<div className="h-screen w-full flex justify-center items-center">
			<div className="bg-blue-200 w-[50%] h-auto rounded-3xl lg:grid lg:grid-cols-2 p-3 gap-4">
				<div className="flex items-center justify-center flex-col p-3">
					<h1 className="uppercase font-bold text-xl">pasc admin login</h1>
					<div className="pt-5 w-full">
						<form className="flex flex-col gap-4" onSubmit={formik.handleSubmit}>
							...
							<div className="w-full pt-4">
								<button className="bg-lime-600 p-2 shadow-md rounded-xl hover:scale-105 duration-300 w-full">
									LOGIN
								</button>
							</div>
						</form>
